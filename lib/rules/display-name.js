...
module.exports = function(context) {
  ...
  return {
    ...
    ClassDeclaration: function(node) {
      ...
      tern('react.isComponent', options, function(err, isComponent) {
        if (isComponent !== true) {
          return;
        }

        tern('react.componentProperties', options, function(err2, props) {
          var hasDisplayName = props.displayName || (acceptTranspilerName && hasTranspilerName(node));
          if (hasDisplayName) {
